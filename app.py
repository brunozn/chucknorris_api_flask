...
def get_jokes_per_category(category):
    '''Retorna uma piada de acordo com a categoria passada'''
...
def get_jokes_search():
    '''Retorna piadas filtradas pela query e quantidade é limitada pelo parametro limit, que caso não seja passado tem valor padrão 5'''
